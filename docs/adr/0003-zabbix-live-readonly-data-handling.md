...
- 状态：Accepted
- 日期：2026-07-20
- 决定者与批准者：Project Lead 提案；项目负责人于 2026-07-20 批准
- 生效日期：2026-07-20（仅允许 mock 预备实现；真实 L4 仍须具备本 ADR 的环境前提）
...
采纳方案 3。当前仍没有真实环境，因此只允许 mock 预备实现；满足以下前提并由 Project Lead 启动 L4 验收前，不发起任何真实网络连接。L4 运行时：
